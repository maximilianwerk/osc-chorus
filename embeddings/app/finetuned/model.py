...
sbert_model = finetuner.get_model('/mnt/models/fine-tuned-sbert-model.zip', device='cpu')
...
clip_text_model = finetuner.get_model('/mnt/models/fine-tuned-clip-model.zip', select_model='clip-text', device='cpu')
