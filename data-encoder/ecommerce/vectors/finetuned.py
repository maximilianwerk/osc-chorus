...
model_img = finetuner.get_model('/home/maximilian/workspace/chorus/models/clip-osc-run.zip', select_model='clip-vision')
model_txt = finetuner.get_model('/home/maximilian/workspace/chorus/models/margin-mse-osc-run.zip')
