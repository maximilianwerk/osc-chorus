...
model_img = finetuner.get_model('models/fine-tuned-clip-model.zip', select_model='clip-vision', device=DEVICE)
model_txt = finetuner.get_model('models/fine-tuned-sbert-model.zip', device=DEVICE)
